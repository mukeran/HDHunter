...
typedef struct qemu_nyx_state_s {
    ...
    int      shared_http_param_fd;
    void    *shared_http_param_ptr;

    int      shared_execution_path_fd;
    void    *shared_execution_path_ptr;
    ...
    uint64_t cap_http_param_vaddr;
    uint64_t cap_execution_path_vaddr;
