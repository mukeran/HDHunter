...
void state_init_global(void)
{
    ...
    global_state.shared_http_param_fd        = 0;
    global_state.shared_http_param_ptr       = NULL;

    global_state.shared_execution_path_fd        = 0;
    global_state.shared_execution_path_ptr       = NULL;
    ...
    global_state.cap_http_param_vaddr                  = 0;
    global_state.cap_execution_path_vaddr              = 0;
