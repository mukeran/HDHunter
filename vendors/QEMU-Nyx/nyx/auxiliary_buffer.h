...
#define AUX_MAGIC 0x54502d554d4582
...
typedef struct auxilary_buffer_cap_s {
    ...
    uint8_t agent_http_param; /* agent uses the http param buffer */
    uint8_t agent_execution_path; /* agent uses the execution path buffer */
...
void set_cap_agent_http_param(auxilary_buffer_t *auxilary_buffer, bool value);
void set_cap_agent_execution_path(auxilary_buffer_t *auxilary_buffer, bool value);
