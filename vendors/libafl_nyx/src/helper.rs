...
pub struct NyxHelper {
    ...
    pub http_param_buffer: *mut u8,
    pub execution_path_buffer: *mut u8,
}
...
impl NyxHelper {
        ...
        P: AsRef<Path>,
    {
        ...
        let http_param_buffer = nyx_process.http_param_buffer_mut().as_mut_ptr();
        let execution_path_buffer = nyx_process.execution_path_buffer_mut().as_mut_ptr();
