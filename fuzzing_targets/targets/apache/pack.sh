...
# Pack
tar -cvf $TARGETS_ROOT/dist/apache.tar build
tar -rvf $TARGETS_ROOT/dist/apache.tar -C startup setup.sh start.sh check_payload port
gzip -f $TARGETS_ROOT/dist/apache.tar
