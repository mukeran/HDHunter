...
import tools.hdhunter.HDHunter;
...
public class IdentityInputFilter implements InputFilter, ApplicationBufferHandler {
    ...
    public int doRead(ApplicationBufferHandler handler) throws IOException {
        ...
        // Update body length
        if (result > 0) {
            HDHunter.incBodyLength(result, HDHunter.MODE_REQUEST);
        }
    ...
    public long end() throws IOException {
        ...
        // Update body length (remaining bytes are swallowed)
        HDHunter.incBodyLength(swallowed + remaining, HDHunter.MODE_REQUEST);
