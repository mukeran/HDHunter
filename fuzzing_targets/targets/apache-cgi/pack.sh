...
# Pack
tar -cvf $TARGETS_ROOT/dist/apache-cgi.tar build
tar -rvf $TARGETS_ROOT/dist/apache-cgi.tar -C startup setup.sh start.sh check_payload port mode
gzip -f $TARGETS_ROOT/dist/apache-cgi.tar
